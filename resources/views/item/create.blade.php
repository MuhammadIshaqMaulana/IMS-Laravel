        ...
        $('#add_material_btn').on('click', function() {
            ...
            const html = `
                <div class="row g-2 mb-2 material-row" id="${rowId}">
                    <div class="col-7"><select class="form-select mat-id shadow-sm" required></select></div>
                    <div class="col-3"><input type="number" step="0.01" class="form-control mat-qty shadow-sm" placeholder="Qty" required></div>
                    <div class="col-2"><button type="button" class="btn btn-danger w-100" onclick="$('#${rowId}').remove()"><i class="fas fa-times"></i></button></div>
                </div>`;
