...
@section('title', 'Catat Produksi Baru')

@section('content')
<div class="row justify-content-center">
    <div class="col-md-8">
        <h1 class="mb-4">Catat Produksi Roti/Kue Baru</h1>
        <div class="card">
            ...
            <div class="card-body">
                ...
                <!-- Rute form action diubah dari transaksi-produksi.store menjadi transaksi.store -->
                <form action="{{ route('transaksi.store') }}" method="POST">
                    @csrf

                    <div class="mb-3">
                        <label for="produk_jadi_id" class="form-label">Produk Jadi yang Diproduksi <span class="text-danger">*</span></label>
                        <select class="form-select @error('produk_jadi_id') is-invalid @enderror" id="produk_jadi_id" name="produk_jadi_id" required>
                            ...
                            @foreach ($produkJadi as $item)
                                <option value="{{ $item->id }}" {{ old('produk_jadi_id') == $item->id ? 'selected' : '' }}>
                                    {{ $item->nama }} (Stok saat ini: {{ number_format($item->stok_di_tangan, 0) }})
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label for="jumlah_produksi" class="form-label">Jumlah Unit Produksi <span class="text-danger">*</span></label>
                            ...
                            <small class="text-muted">Masukkan berapa banyak unit produk ini yang berhasil dibuat.</small>
                    ...
                    <!-- Rute tombol batal diubah dari transaksi-produksi.index menjadi transaksi.index -->
